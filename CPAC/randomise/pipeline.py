...
def create_randomise(name='randomise', working_dir=None, crash_dir=None):
    ...
    inputspec = pe.Node(util.IdentityInterface(fields=[
        ...
        'mask_boolean', 'demean', 'c_thresh']), name='inputspec')
    ...
    wf.connect(randomise, 't_corrected_p_files',
               outputspec, 't_corrected_p_files')
# --------------------------------------------------------------------
# issue here arises while using tfce. By not using tfce, you don't get
# t_corrected_p files. R V in a conundrum?
# --------------------------------------------------------------------
    ...
    wf.connect(randomise, 't_corrected_p_files',
               select_tcorrp_files, 'input_list')
    wf.connect(select_tcorrp_files, 'out_file',
               outputspec, 'out_tcorr_corrected')
    ...
    wf.connect(select_tstat_files, 'out_file',
               outputspec, 'out_tstat_corrected')
